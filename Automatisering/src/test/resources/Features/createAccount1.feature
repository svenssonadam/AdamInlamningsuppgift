...
|email|@hotmail.com|username|Password123&|Check your email|
...
Examples:
|email|hotmail|username                                                                                             |password    |verify|
|email|@hotmail.com|longUsername|Password123&|Enter a value less than 100 characters long|
...
Examples:
|email|hotmail|username|password    |verify|
|email|@hotmail.com|Adam653|Password123&|Another user with this username already exists. Maybe it's your evil twin. Spooky.|
